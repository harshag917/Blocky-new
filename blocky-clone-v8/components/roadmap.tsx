        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mt-16">
          ...
          >
            <Button
              ...
              onClick={() =>
                window.open("https://www.coingecko.com/en/coins/blocky-ai-agent", "_blank", "noopener,noreferrer")
              }
            >
              CoinGecko
          ...
          >
            <Button
              className="bg-gray-800 hover:bg-gray-700 text-white rounded-full px-8 py-6 text-lg w-full"
