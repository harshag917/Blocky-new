          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm md:text-base break-all text-amber-500">
                CsZFPqMei7DXBfXhCydAPBN9y5wzrYmYGwBhLLRT3iU
              </p>
            </div>
            ...
            <FadeIn direction="up" delay={0.5} duration={0.7}>
              <div className="relative">
                ...
                <p className="text-gray-400 italic text-base md:text-lg mb-6 md:mb-8 max-w-xl pl-2 md:pl-4">
                  Legend has it that every time Bitcoin hits a new ATH, his block grows sharper, his chain gets heavier,
                  and his grin widens. No one knows who controls him. No one knows if he's code or man. But every meme,
                  every viral tweet, every market rally - he's there, watching with his sunglasses, ready to flex.
                </p>
